...
public class PrimeFactorizer {
	...
	public static void main(String[] args) {
		...
		fac = new PrimeFactorizer(16);
		fac.generatePrimeFactors();
		System.out.println(fac.getPrimeFactors());

		System.out.print("Prime factors of 124: ");
		fac = new PrimeFactorizer(124);
		fac.generatePrimeFactors();
		System.out.println(fac.getPrimeFactors());
		...
		System.out.print("Prime factors of 2048: ");
		fac = new PrimeFactorizer(2048);
		fac.generatePrimeFactors();
		System.out.println(fac.getPrimeFactors());

		System.out.print("Prime factors of 9999: ");
		fac = new PrimeFactorizer(9999);
		fac.generatePrimeFactors();
		System.out.println(fac.getPrimeFactors());
	}
}