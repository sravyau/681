...
public class RunnablePrimeFactorizer extends PrimeFactorizer implements Runnable {
	...
	public static void main(String[] args) {
		...
		System.out.println("Factorization of 6");
		RunnablePrimeFactorizer runnable = new RunnablePrimeFactorizer(6, 2, (long) Math.sqrt(6));
		...
		// Factorization of 2048 with two threads
		System.out.println("Factorization of 2048");
		runnables.add(new RunnablePrimeFactorizer(2048, 2, (long) Math.sqrt(2048) / 2));
		runnables.add(new RunnablePrimeFactorizer(2048, 1 + (long) Math.sqrt(2048) / 2, (long) Math.sqrt(2048)));
